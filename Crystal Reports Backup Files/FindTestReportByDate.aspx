<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FindTestReportByDate.aspx.cs" Inherits="DCBMS.UI.FindTestReportByDate" %>
                     ...
                     <Columns>
                        <asp:TemplateField HeaderText = "SL" ItemStyle-Width="100">
                            <ItemTemplate>
                             ...
                             <asp:BoundField DataField="TestName" HeaderText="Test Name" ItemStyle-Width="150" SortExpression="testname" />

                        <asp:BoundField DataField="TotallTest" HeaderText="Totall Test" ItemStyle-Width="150" SortExpression="fee" />
